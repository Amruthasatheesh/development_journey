...
#diplay different types of region
types_of_region={di.get("region")for di in penguin_data}
print("types_of_region",types_of_region)

#display bodymass of region Anvers
Anvers_bodymass=[di.get("body_mass")for di in penguin_data if di.get("region")=="Anvers"]
print("Anvers bodymass",Anvers_bodymass)

#display highest bodymass region
max_bodymass=max(di.get("body_mass")for di in penguin_data )
print("maximum bodymass",max_bodymass)

max_bodymass_region=[di.get("region") for di in penguin_data if di.get("body_mass")==max_bodymass]
print("maximum  bodymass region",max_bodymass_region)

#highest flipper_length
max_flipper_length=max(di.get("flipper_length")for di in penguin_data)
print("highest flipper length",max_flipper_length)

#display total of bill_depth 
billdepth_total=sum(di.get("bill_depth")for di in penguin_data)
print(" total billdepth",billdepth_total)

#display sorted body mass of region biscoe

sorted_bodymass=[di.get("body_mass")for di in penguin_data if di.get("region")=="Biscoe"]
print("sorted bodymass",sorted(sorted_bodymass))

#avg of flipper_length in region dream
flipper_length_of_region_dream=[di.get("flipper_length")for di in penguin_data if di.get("region")=="Dream"]
print("flipper_length of region dream",(flipper_length_of_region_dream))
total_of_flipper_length=sum(flipper_length_of_region_dream)
count_of_flipper_length=len(flipper_length_of_region_dream)
#avg=total/count
avg=total_of_flipper_length/count_of_flipper_length
print("avg of flipper length in region dream is",avg)
