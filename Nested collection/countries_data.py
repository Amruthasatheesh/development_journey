...
total_countries=[di.get("country_name") for di in countries_data ]
print(len(total_countries))

total_asian=[di for di in countries_data if di.get("region")=="Asia"]
print(len(total_asian))

country_highest_population=max(di.get("population")for di in countries_data)
print(country_highest_population)
country_max=[di for di in countries_data if di.get("population")==country_highest_population]
print("highest_population country",country_max)
sort_wrt_population=sorted([[di.get("population"),di.get("country_name")] for di in countries_data ])
print(sort_wrt_population)

all_unique_region={di.get("region")for di in countries_data}
print(all_unique_region)

independant_country_names=[di.get("country_name")for di in countries_data if di.get("is_independent")==True]
print(independant_country_names)